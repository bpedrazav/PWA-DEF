...
// =========================================================================
// 0. BASE DE DATOS (MONGODB ATLAS)
// =========================================================================
const MONGO_URI = 'mongodb+srv://crackkkkkk:Admin123@cluster0.dsvee7y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
// =========================================================================
// 0. SYNC ENDPOINTS PARA USUARIOS
// =========================================================================
app.get('/api/sync/:username', async (req, res) => {
  ...
  try {
    if (!usersCollection) return res.status(500).json({ error: 'DB not connected' });
    const userProfile = await usersCollection.findOne({ _id: username });
    if (userProfile) {
      return res.json({ success: true, data: userProfile.data });
    }
